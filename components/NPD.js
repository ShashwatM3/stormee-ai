    ...
    <div className='npd-main'>
      <div>
        <div className='flex items-center justify-center flex-col gap-10 mb-10'>
          <h1 className='scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl'>The <HoverCard><HoverCardTrigger className='text-blue-400 cursor-pointer border-b'>NPD</HoverCardTrigger><HoverCardContent className='dark'><b><i>New Product Development</i></b> &#8212; process of bringing a new product or service to market through a structured approach involving several stages from ideation to launch. </HoverCardContent></HoverCard> Journey</h1>
          {curr==0 ? (
        ...
        <div id="withoutStormee" className='flex items-start justify-center gap-4 flex-wrap'>
          ...
          <Card className='bg-neutral-800 border-none w-[20vw] min-h-[20vh] text-white'>
            <CardHeader>
        ...
        <div id="withStormee" className='flex items-start justify-center gap-4 flex-wrap'>
          {stages.map((stage, index) => (
              stage.stormee=='yes' ? (
                <Card key={index} className='dark w-[20vw] min-h-[20vh]'>
                  <CardHeader>
