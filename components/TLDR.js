  ...
  return (
    <div className='tldr-main'>
      <div className='tldr-con'>
        <h1 className='scroll-m-20 pb-2 text-3xl font-semibold tracking-tight first:mt-0'>TL;DR &#8212; Stormee's Give & Take</h1>
        <div>
          <div>
          ...
          <div>
            ...
            <ul>
            <li>Clear-cut Validation</li>
            <li>How the Idea could perform better</li>
